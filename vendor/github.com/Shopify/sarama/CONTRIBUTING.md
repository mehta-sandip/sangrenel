...
- Explicitly handle all error return values. If you really want to ignore an error value, you can assign it to `_`.You can use [errcheck](https://github.com/mehta-sandip/sangrenel/vendor/github.com/kisielk/errcheck) to verify whether you have handled all errors.
- You may also want to run [golint](https://github.com/mehta-sandip/sangrenel/vendor/github.com/golang/lint) as well to detect style problems.
